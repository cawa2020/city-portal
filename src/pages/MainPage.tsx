              ...
              {request.photoUrl && (
                <div className="mb-4 relative">
                  <img 
                    ...
                    alt={request.title}
                    className={`relative z-10 w-full h-48 object-cover rounded-md transition-opacity duration-300 ${request.photoUrlAfter ? 'hover:opacity-0' : null}`}
                    onError={(e) => {
                  ...
                  />
                  {request.photoUrlAfter && (
                  <img 
                    src={request.photoUrlAfter} 
                    alt={request.title}
                    className="top-0 absolute w-full h-48 rounded-md"
                  />
                  )}
                </div>
              )}
